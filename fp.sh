...
./build/nicolas -a ucb -m update --number-of-queries 10000 -r 10000 -c 100 -i /home/yan/codes/nicolas/100M_100/ -n 100000000 -v yes --show-memory no --fence-pointer yes --fence-length 1000000000 > ucb_fp_no
